...
(cl:defmethod cl:initialize-instance :after ((m <SystemState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SystemState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller-msg:<SystemState> is deprecated: use controller-msg:SystemState instead.")))
